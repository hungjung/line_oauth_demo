...
<head>
    ...
    <title>訊息訂閱系統 - @yield('title')</title>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">取消 Cancel</button>
                    <a class="btn btn-primary" href="/logout">登出 Logout</a>
                </div>
            </div>
        </div>
    </div>
